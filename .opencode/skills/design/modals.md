...
- Subtitle (optional): 14px, `var(--color-text-secondary)`, 4px top margin
- Close button: ghost variant from `buttons.md`, top-right, 8px padding

### Body
- Padding: 24px
- Vertical spacing between elements: 16px
- Text: 14px, 1.6 line-height, `var(--color-text-secondary)`
...
- Content: `var(--color-bg-surface)` bg, 8px radius, `$shadow-xl`
