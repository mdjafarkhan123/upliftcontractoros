...
const automationPatchSchema = z
	.object({
		...
		job_scheduled_confirmation_enabled: z.boolean().optional(),
		job_scheduled_sms_message: z.string().min(1).max(MSG_MAX).optional(),
		job_scheduled_email_subject: z.string().min(1).max(200).optional(),
		job_scheduled_email_message: z.string().min(1).max(2000).optional(),

		job_on_my_way_enabled: z.boolean().optional(),
		job_on_my_way_sms_message: z.string().min(1).max(MSG_MAX).optional(),
		job_on_my_way_email_subject: z.string().min(1).max(200).optional(),
		job_on_my_way_email_message: z.string().min(1).max(2000).optional(),
...
const RETURN_COLUMNS = {
	...
	job_scheduled_confirmation_enabled: automationSettings.job_scheduled_confirmation_enabled,
	job_scheduled_sms_message: automationSettings.job_scheduled_sms_message,
	job_scheduled_email_subject: automationSettings.job_scheduled_email_subject,
	job_scheduled_email_message: automationSettings.job_scheduled_email_message,
	job_on_my_way_enabled: automationSettings.job_on_my_way_enabled,
	job_on_my_way_sms_message: automationSettings.job_on_my_way_sms_message,
	job_on_my_way_email_subject: automationSettings.job_on_my_way_email_subject,
	job_on_my_way_email_message: automationSettings.job_on_my_way_email_message,
