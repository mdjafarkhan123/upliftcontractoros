					...
					<div class="flex items-start gap-3">
						...
						<div class="min-w-0 flex-1">
							...
							<div class="mt-3 flex flex-wrap items-center gap-2">
								...
								{#if q.opportunity_id}
									<a
										href="/pipeline?deal={q.opportunity_id}"
										class="inline-flex h-8 items-center rounded-md border border-border px-3 text-sm font-medium hover:bg-muted"
									>
										Mark deal lost
									</a>
								{/if}
