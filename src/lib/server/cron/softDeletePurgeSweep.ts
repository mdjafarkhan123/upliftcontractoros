 ...
 * Retention: 30 days — the window shown to users in the recycle bin. Long enough
 *           to recover a mistaken delete, short enough to honor data-retention
 *           expectations (GDPR/CCPA). Matches the contact purge window.
