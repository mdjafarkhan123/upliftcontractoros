...
<Dialog.Root bind:open>
	<Dialog.Content class="request-convert">
		...
		<div class="request-convert__list">
			<button type="button" class="request-convert__row" onclick={() => pick(onConvertQuote)}>
			...
			<button type="button" class="request-convert__row" onclick={() => pick(onConvertJob)}>
			...
			<button type="button" class="request-convert__row" onclick={() => pick(onArchive)}>
			...
			<button type="button" class="request-convert__row" onclick={() => pick(onLeave)}>
				<span class="request-convert__icon">
