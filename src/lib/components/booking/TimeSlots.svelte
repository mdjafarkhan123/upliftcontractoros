...
{:else if slots.length === 0}
	<div
		class="rounded-2xl border border-border/60 bg-card/40 px-6 py-10 text-center"
	>
						...
						<button
							...
							class={cn(
								...
								isSelected
									...
									: 'border-border/60 bg-card/60 text-foreground hover:border-border hover:bg-accent/60 hover:shadow-[0_4px_14px_-6px_hsl(var(--brand-primary)/0.4)]'
							)}
						>
							{slot.label}
						</button>
