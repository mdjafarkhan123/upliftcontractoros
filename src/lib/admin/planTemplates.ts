...
export const limitsSchema = z.object({
	...
	max_sms_per_minute: limit,
	max_sms_per_day: limit,
...
const ELITE: PlanTemplate = {
	...
	limits: {
		...
		max_sms_per_minute: 120,
		max_sms_per_day: 25_000,
