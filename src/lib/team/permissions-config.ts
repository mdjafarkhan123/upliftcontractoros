...
export const PERMISSION_GROUPS: PermissionGroup[] = [
	{
		...
		permissions: [
			...
			},
			{
				...
				label: 'View revenue',
				description: 'See revenue charts and financial summaries'
			},
			{
				key: 'can_view_pipeline_snapshot',
				label: 'View pipeline snapshot',
				description: 'View pipeline value and stage counts'
			}
		]
	},
	{
		...
		permissions: [
			{
				...
				description: 'See all team conversations, not just assigned ones'
			},
			{
				key: 'can_view_assigned_conversations',
				label: 'View assigned conversations',
				description: 'See conversations assigned to them'
			},
			{
				key: 'can_send_messages',
				label: 'Send messages',
				description: 'Reply to and send SMS messages'
			},
			{
				key: 'can_delete_conversations',
				label: 'Delete conversations',
				description: 'Archive or delete conversation threads'
			}
		]
	},
	{
		...
		permissions: [
			{
				...
				description: 'Browse the full contact list'
			},
			{
				key: 'can_create_contacts',
				label: 'Create contacts',
				description: 'Add new leads and customers'
			},
			{
				key: 'can_edit_contacts',
				label: 'Edit contacts',
				description: 'Update contact details and status'
			},
			{
			...
			},
			{
				...
				description: 'Combine duplicate contacts into one record'
			}
		]
	},
	{
		...
		permissions: [
			{
				...
				description:
					'See the full pipeline across every stage, including teammates’ deals and total stage revenue'
			},
			{
				key: 'can_view_assigned_opportunities',
				label: 'View only their assigned opportunities',
				description:
					'See just the deals where they are the assignee — totals and other reps’ cards stay hidden'
			},
			{
				key: 'can_move_pipeline_stages',
				label: 'Move pipeline stages',
				description: 'Drag opportunities between pipeline stages'
			},
			{
		...
		permissions: [
			{
				...
				description: 'View jobs assigned to them'
			}
		]
	},
	{
		...
		permissions: [
			{
				...
				description: 'Browse all quotes in the org'
			},
			{
				key: 'can_create_quotes',
				label: 'Create quotes',
				description: 'Generate new quotes for contacts'
			},
			{
				key: 'can_send_quotes',
				label: 'Send quotes',
				description: 'Send quotes to clients via SMS or email'
			},
			{
				key: 'can_edit_quotes',
				label: 'Edit quotes',
				description: 'Modify quote line items and totals'
			},
		...
		permissions: [
			{
				...
				description: 'Browse all invoices in the org'
			},
			{
	...
	},
	{
		...
		permissions: [
			...
			},
			{
				...
				description: 'View appointments assigned to them'
			},
			{
			...
			},
			{
				...
				description: 'Change appointment times and dates'
			}
		]
	},
	{
		...
		permissions: [
			...
			},
			{
				...
				description: 'Request reviews from completed jobs'
			},
			{
				key: 'can_view_negative_feedback',
				label: 'View negative feedback',
				description: 'See private negative feedback'
			}
		]
	},
	{
		...
		permissions: [
			{
				...
				description: 'Access the agency growth feed'
			}
		]
	},
	{
		...
		permissions: [
			...
			},
			{
				...
				label: 'Upload files',
				description: 'Upload photos, documents, and media'
			},
			{
		...
		permissions: [
			{
				...
				description: 'View the team list and member details'
			},
			{
				key: 'can_create_team_members',
				label: 'Create team members',
				description: 'Invite and create new team accounts'
			},
			{
				key: 'can_edit_team_members',
				label: 'Edit team members',
				description: 'Edit team member permissions'
			},
			{
				key: 'can_delete_team_members',
				label: 'Deactivate team members',
				description: 'Deactivate members to revoke their access'
			}
		]
	}
];
