...
- Content: flex column — name (14px, medium, `var(--color-text-primary)`) + task description (13px, `var(--color-text-secondary)`)
...
- Content: flex column — task name (14px, medium, `var(--color-text-primary)`) + due date (12px, `var(--color-text-muted)`)
