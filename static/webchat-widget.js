(function(){(function(){let e=document.currentScript,t=e?.getAttribute(`data-widget-token`);if(!t){console.warn(`[WebChat] Missing data-widget-token attribute.`);return}let n=e?.src?new URL(e.src).origin:window.location.origin,r=`wc_session_${t}`,i=`wc_cursor_${t}`,a=null,o=!1,s=null,c=!1;function l(){try{return localStorage.getItem(i)}catch{return null}}function u(e){try{let t=l();(!t||e>t)&&localStorage.setItem(i,e)}catch{}}function d(){try{localStorage.removeItem(i)}catch{}}let f=null,p=null,m=null,h=null,g=null;function _(e){return`
