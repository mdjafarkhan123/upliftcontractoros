...
- Logo: 32×32px + app name text (16px, semibold, `var(--color-text-primary)`)
...
- Text: 11px, uppercase, letter-spacing 0.6px, `var(--color-text-muted)`, medium
- Padding: 0 8px
...
- Icon: 20×20px, `var(--color-text-secondary)` color
...
- Badge: number, pill, 20px height, `var(--color-brand)` bg, white text, 11px, semibold
- Padding: 0 6px
...
- Email: 12px, `var(--color-text-muted)`, truncated
